...
const Home = () => {
  return (
    <Container
      maxWidth="lg"
      sx={{ backgroundColor: "#f3f0ff", py: 4, borderRadius: 3 }}
    >
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                >
                  <WorkIcon
                    sx={{ fontSize: { xs: 30, sm: 40 }, color: "#ff9800" }}
                  />
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                >
                  <AssessmentIcon
                    sx={{ fontSize: { xs: 30, sm: 40 }, color: "#e57373" }}
                  />
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                >
                  <NotificationsIcon
                    sx={{ fontSize: { xs: 30, sm: 40 }, color: "#3f51b5" }}
                  />
            ...
            <Grid item xs={12} sm={6}>
              ...
              >
                ...
                >
                  <StarIcon
                    sx={{ fontSize: { xs: 30, sm: 40 }, color: "#000000" }}
                  />
          ...
          <ButtonBase sx={{ width: "100%", marginTop: "5%" }}>
            ...
            >
              ...
              >
                ...
                <Typography
                  variant="h6"
                  sx={{ ml: 1, fontWeight: "bold", p: 0.5, borderRadius: 1 }}
                >
                  Tips Box
                </Typography>
              </Box>
